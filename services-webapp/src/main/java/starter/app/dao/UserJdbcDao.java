...
public class UserJdbcDao {
    ...
    protected static final String queryPattern = "select * from user where username = ?";
    ...
    public UserCredential getUserCredential(String username) {
        ...
        return jdbcTemplate.queryForObject(queryPattern, new Object[]{username}, new RowMapper<UserCredential>() {
            @Override
